...
SECRET_KEY = 'django-insecure-&iwp$%6^k%5n73s3t&29y1n(1z1@ap@iqixd8ylmi-3*%#_7^8'
...
# ROOT_URLCONF = 'Instituto.urls'   # modifique nombre de la carpeta
...
# WSGI_APPLICATION = 'Instituto.wsgi.application'   # modifique nombre de la carpeta
